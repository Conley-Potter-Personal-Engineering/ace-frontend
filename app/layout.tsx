                ...
                <Card className="m-4 bg-card/80">
                  <CardContent className="flex items-center justify-between gap-6 p-5 md:p-6">
                    <div className="space-y-1">
                      ...
                      <p className="text-base font-semibold">ops@ace.dev</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="flex items-center gap-2 rounded-full bg-muted px-3 py-1 text-sm font-medium text-foreground">
